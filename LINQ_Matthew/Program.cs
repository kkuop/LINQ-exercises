...
namespace LINQ_Matthew
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.ReadLine();
            string collapsableString = "Van Hecke";
            Console.WriteLine(Problems.ProblemFour(collapsableString));
            Console.ReadLine();
            Console.WriteLine(Problems.ProblemFourSingleLine(collapsableString));
            Console.ReadLine();
        }
    }
}
